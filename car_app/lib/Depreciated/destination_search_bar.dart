...
//     try {
//       final LatLng destinationCoordinates = await NavigationService.geocodeAddress(input);
//       setState(() {
//         LocationService.destination = destinationCoordinates;
//       });
//
//       final address = await NavigationService.reverseGeocode(destinationCoordinates);
